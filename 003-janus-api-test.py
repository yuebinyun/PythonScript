...
def main():
    ws = websocket.create_connection("ws://10.0.17.102:8188", subprotocols=['janus-protocol'])
    ...
    msg = {"janus":"attach", "transaction": t_generator(),  "plugin": "janus.plugin.videoroom", "session_id": session_id}
    ws.send(json.dumps(msg))
    ...
    msg = {"janus":"message", "transaction": t_generator(),  "handle_id": handle_id, "session_id": session_id, "body": body}
    ws.send(json.dumps(msg))
